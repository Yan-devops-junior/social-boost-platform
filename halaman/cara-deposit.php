                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="box-content text-center">
                            ...
                            <div style="text-align:center;padding-top:20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-bni.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-bri.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-bca.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-gopay.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-ovo.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-dana.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-telkomsel.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-xl.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                                <img src="/assets/images/pembayaran/kincaimedia-deposit-axis.png" alt="Cara Deposit di <?php echo $data['short_title']; ?>" title="Cara Deposit di <?php echo $data['short_title']; ?>" style="height:100%;max-height:80px;margin:10px 20px">
                            </div>
                        </div>
                    </div>
                </div>
