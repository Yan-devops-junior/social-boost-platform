...
<div class="row">
  <div class="col-lg-4">
    <div class="card">
      <div class="card-body">
        <center><img src="/assets/images/kincaimedia/blackexpostore1.png"  alt="user-img" class="card-img-top" style="max-width:200px;"></img></center>    
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="text-right">
            <h4 class="text-dark mt-1"><span><?php echo $jumlah_order_sosmed; ?></span></h4>
