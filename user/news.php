            ...
            <div class="card-body">
                ...
                <div class="table-responsive" style="display: inline-grid;">
                    <table class="able table-striped table-hovered nowrap mb-0">
                        <tbody>
                            <?php $check_news = $conn->query("SELECT * FROM berita ORDER BY id DESC LIMIT 10"); ?>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h4 class="m-t-0 text-uppercase text-center header-title"><i aria-hidden="true" class="fa fa-rss "></i> <b>NETWORK</b></h4><hr/>
                <div class="table-responsive" style="display: inline-grid;">
                    <table class="able table-striped table-hovered nowrap mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://401xd.com" class="text-dark">401XD Group
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://seosecret.id" class="text-dark">SEO Secret
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://webtool.seosecret.id" class="text-dark">Web Tools
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://webtool.seosecret.id/tiktok/public/" class="text-dark">Tiktok Downloader
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://safelink.asia" class="text-dark">Safelink Asia
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://mycoding.net" class="text-dark">Project Mycoding.net
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://mycoding.id" class="text-dark">Project Mycoding.id
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://blog.kincaimedia.net" class="text-dark">Blog Kincaimedia.net
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://teknologi.kincaimedia.net" class="text-dark">Teknologi Kincaimedia.net
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://gadget.kincaimedia.net" class="text-dark">Gadget Kincaimedia.net
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://traveling.kincaimedia.net" class="text-dark">Traveling Kincaimedia.net
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding-left: 5px;">
                                    <a href="https://movie.kincaimedia.net" class="text-dark">Movie Kincaimedia.net
                                    </a>
                                </td>
                            </tr>
                        </tbody>
