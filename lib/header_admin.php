                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">                            
                            <li class="has-submenu">
                                <a href="/mimintop/"><i class="fi-air-play"></i> <span>  Dashboard</span> </a>
                            </li>

                            <li class="has-submenu">
                                <a href="/mimintop/action-provider"><i class="mdi mdi-server-security"></i> <span> Provider </span> </a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="mdi mdi-cart-plus"></i> <span> Layanan </span> </a>
                                <ul class="submenu">
                                    <li><a href="/mimintop/kategori-layanan">Kelola Kategori</a></li>
                                    <li><a href="/mimintop/layanan-sosmed">Sosial Media</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="/mimintop/pengguna">Kelola Pengguna</a></li>
                                    <li><a href="/mimintop/harga-pendaftaran">Harga Pendaftaran</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="/mimintop/metode-deposit">Kelola Metode</a></li>
                                    <li><a href="/mimintop/voucher">Kelola Voucher</a></li>
                                    <li><a href="/mimintop/deposit-bank">Deposit Bank</a></li>
                                    <li><a href="/mimintop/deposit-emoney">Deposit Emoney</a></li>
                                    <li><a href="/mimintop/deposit-epayment">Deposit Epayment</a></li>
                                    <li><a href="/mimintop/deposit-tsel">Deposit Tsel</a></li>
                                    <li><a href="/mimintop/deposit-voucher">Deposit Voucher</a></li>
                                    <li><a href="/mimintop/deposit">Deposit Lainnya</a></li>
                                </ul>
                            </li>

                            <li class="has-submenu">
                                <a href="/mimintop/sosial-media"><i class="mdi mdi-cart-plus"></i> <span> Pesanan </span> 
                            ...
                            <li class="has-submenu">
                                <a href="/mimintop/tiket"><i class="dripicons-ticket"></i> <span>Tiket</span>
                            ...
                            <li class="has-submenu">
                                <a href="/mimintop/laporan-sosmed"><i aria-hidden="true" class="fa fa-book"></i> <span> Laporan </span> </a>
                            </li>                                                                                 
                            <li class="has-submenu">
                                <a href="#"><i class="mdi mdi-file-multiple"></i> <span> Aktivitas </span> </a>
                                <ul class="submenu">
                                    <li><a href="/mimintop/aktifitas-pengguna">Semua Pengguna</a></li>
                                    <li><a href="/mimintop/penggunaan-saldo">Mutasi Saldo</a></li>
                                    <li><a href="/mimintop/transfer-saldo">Transfer Saldo</a></li>
                                </ul>
                            </li>        
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="/mimintop/berita">Kelola Berita</a></li>
                                    <li><a href="/mimintop/halaman-lain">Kelola Halaman</a></li>
                                    <li><a href="/mimintop/pengaturan-website">Pengaturan Web</a></li>
                                </ul>
                            </li>       
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                if (isset($_SESSION['hasil'])) {
                    ?>
                    <div class="alert alert-<?php echo $_SESSION['hasil']['alert'] ?> alert-dismissible mt-3" role="alert">
