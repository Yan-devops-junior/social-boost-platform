...
<script type='application/ld+json' class='SEOSecretIDN'>
  {
    ...
    "@graph": [
    {
      ...
      "@id": "#LogoWebSite",
      "inLanguage": "id-ID",
      "url": "<?php echo $config['web']['url'];?>assets/images/kincaimedia/blackexpo512.png",
      "caption": "<?php echo $data['short_title'];?>"},
      "image": {
      "@type": "ImageObject",
      "@id": "#ImageWebSite",
      "inLanguage": "id-ID",
      "url": "<?php echo $config['web']['url'];?>assets/images/kincaimedia/blackexpo.png",
      "caption": "<?php echo $data['short_title'];?>"},
      "address": {
      "@type": "PostalAddress",
...
<script type='application/ld+json' class='SEOSecretIDN'>
  {
    ...
    "priceRange": "$",
    "hasMap": "https://www.google.com/maps/search/401XD+Group/@-0.9003501,100.3385632,15z",
  ...
  "@id": "#LogoWebSite",
  "inLanguage": "id-ID",
  "url": "<?php echo $config['web']['url'];?>assets/images/kincaimedia/partner.png",
...
<script type='application/ld+json' class='SEOSecretIDN'>
  {
    ...
    "author": "Kiki Lesvina",
    "description": "Aman dan proses cepat. Sangat membantu sekali, terimakasih kincaimedia",
    "reviewRating": {
    "@type": "Rating",
    "@id": "#RatingSoftware",
    "ratingValue": "4.9",
...
<script type='application/ld+json' class='SEOSecretIDN'>
  {
    ...
    "@graph": [
    {
      ...
      "name": "Ulasan Reseller Produk",
      "author": "Kiki Lesvina",
      "description": "Harga layanan disini cukup murah bagi pemilik UMKM seperti saya, penggunaan aplikasi nya juga aman dan proses cepat. Sangat membantu sekali, terimakasih kincaimedia",
      "reviewRating": {
      "@type": "Rating",
      "ratingValue": "4.9",
      "worstRating": "1",
