...
<div class="row">
    <div class="col-md-12">
        <br /><h2 class="text-center">Manajemen Data Tiket Dukungan Pelanggan</h2><br/>
    </div>
</div>
<!-- End-Page-Title -->
                    ...
                    <table class="table table-striped table-bordered nowrap m-0">
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo $config['web']['url'];?>mimintop/ajax/tiket/reply?id=<?php echo $data_tiket['id']; ?>" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fa fa-reply" title="Reply"></i></a>
                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/tiket/tutup?id=<?php echo $data_tiket['id']; ?>')" class="btn btn-sm btn-warning"><i aria-hidden="true" class="fa fa-close" title="Tutup"></i></a>
                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/tiket/hapus?id=<?php echo $data_tiket['id']; ?>')" class="btn btn-sm btn-danger"><i aria-hidden="true" class="fa fa-trash" title="Tutup"></i></a>
                                </td>
                            </tr>   
                            <?php } ?>
                        </tbody>
