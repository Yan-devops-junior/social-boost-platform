                            ...
                            <tr>
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id_deposit=<?php echo $data_depo['kode_deposit']; ?>" class="form-inline" role="form" method="POST"> 
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="javascript:;" onclick="deposit('<?php echo $config['web']['url'];?>mimintop/ajax/deposit/view-deposit-tsel?kode_deposit=<?php echo $data_depo['kode_deposit']; ?>')" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fa fa-eye" title="view"></i></a>
