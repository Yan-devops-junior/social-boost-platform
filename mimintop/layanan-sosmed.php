...
<div class="row">
    <div class="col-md-12">
        <br /><h2 class="text-center">Manajemen Data dan Harga Layanan Sosmed</h2><br/>
    </div>
</div>
<!-- End-Page-Title -->
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="m-t-0 header-title"><b><i aria-hidden="true" class="fa fa-list"></i> Layanan Sosial Media</b></h4>
                <form>
                    <div class="row">
