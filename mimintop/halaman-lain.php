                    ...
                    <table class="table table-striped table-bordered nowrap m-0">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td><a href="<?php echo $config['web']['url'];?>mimintop/ajax/halaman-lain/edit.php?id=<?php echo $ShowData['id']; ?>" class="btn btn-warning btn-xs"><i aria-hidden="true" class="fa fa-edit"></i></a></td>                               
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
