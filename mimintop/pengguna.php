...
if (isset($_POST['tambah'])) {
    ...
    if (!$level || !$email) {
        ...
        if (empty($password) == true) {
            if ($conn->query("UPDATE users SET email = '$email', level = '$level', saldo = '$saldo' WHERE id = '$get_id'") == true) {
            ...
            if ($conn->query("UPDATE users SET email = '$email', password = '$password_hash', level = '$level', saldo = '$saldo' WHERE id = '$get_id'") == true) {
                        ...
                        <tbody>
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $data_pengguna['id']; ?>" class="form-inline" role="form" method="POST">
                                    ...
                                    <td align="center">
                                        <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/pengguna/view?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-info"><i aria-hidden="true" class="fa fa-list" title="Edit"></i></a>
                                        <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/pengguna/edit?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-warning"><i aria-hidden="true" class="fa fa-pencil" title="Edit"></i></a>
                                        <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/pengguna/delete?id=<?php echo $data_pengguna['id']; ?>')" class="btn btn-sm btn-danger"><i aria-hidden="true" class="fa fa-trash" title="Hapus"></i></a>
                                    </td>                                                
                                </form>
                            </tr>
                            <?php } ?>
