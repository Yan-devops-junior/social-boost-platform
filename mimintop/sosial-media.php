...
<div class="row">
    <div class="col-md-12">
        <br /><h2 class="text-center">Laporan Order dan Penjualan Layanan Sosial Media</h2><br/>
    </div>
</div>
<!-- End-Page-Title -->
        ...
        <div class="card widget-box-three">
            <div class="card-body">
                ...
                <div class="text-right">
                    ...
                    <h3 class="m-b-10"><span>Rp <?php echo number_format($data_pesanan_sosmed['total'],0,',','.'); ?> Dari <?php echo $jumlah_pesanan_sosmed; ?> Pesanan</span></h3>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="m-t-0 header-title"><b><i aria-hidden="true" class="fa fa-list"></i>    Pesanan Sosial Media</b></h4>                              
                <form>
                    <div class="row">
