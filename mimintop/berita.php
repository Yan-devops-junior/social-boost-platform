                    ...
                    <table class="table table-striped table-bordered nowrap m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/berita/edit?id=<?php echo $data_berita['id']; ?>')" class="btn btn-sm btn-warning"><i aria-hidden="true" class="fa fa-pencil" title="Edit"></i></a>
                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/berita/delete?id=<?php echo $data_berita['id']; ?>')" class="btn btn-sm btn-danger"><i aria-hidden="true" class="fa fa-trash" title="Hapus"></i></a>
                                </td>
                            </tr>
                            <?php } ?>                                        
                        </tbody>
