...
if (isset($_POST['edit'])) {
    ...
    if ($conn->query("UPDATE setting_web SET short_title = '$PostStitle', title = '$PostTitle', deskripsi_web = '$PostDescWeb', kontak_utama = '$PostKontak', alamat = '$PostAlamat', url_alamat = '$PostUrlAlamat', facebook = '$PostFB', url_facebook = '$PostUrlFB', instagram = '$PostIG', url_instagram = '$PostUrlIG', whatsapp = '$PostWA', url_whatsapp = '$PostUrlWA', youtube = '$PostYT', url_youtube = '$PostUrlYT', twitter = '$PostTW', url_twitter = '$PostUrlTW', email = '$PostEmail', url_email = '$PostUrlEmail', jam_kerja = '$PostJamKerja' WHERE id = '1'") == true) {
                    ...
                    <table class="table table-striped table-bordered nowrap m-0">
                        <tbody>
                            ...
                            <tr>
                                <th>Aksi</th>
                                <td>
                                    <a href="javascript:;" onclick="users('<?php echo $config['web']['url'];?>mimintop/ajax/pengaturan-website/edit?id=1')" class="btn btn-sm btn-warning"><i aria-hidden="true" class="fa fa-pencil" title="Edit"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    `   </tbody>
