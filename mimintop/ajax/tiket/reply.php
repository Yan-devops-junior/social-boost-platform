...
if (mysqli_num_rows($CallDBTiket) == 0) {
	...
	exit(header("Location: ".$config['web']['url']."mimintop/tiket"));
} else {
			...
			<div class="card-body">
				...
				<form class="form-horizontal" role="form" method="POST">
					...
					<div class="card-footer text-muted">
						<a href="<?php echo $config['web']['url'];?>mimintop/tiket" class="btn btn-inverse"><i  class="mdi mdi-arrow-left-bold"></i> Kembali</a>
