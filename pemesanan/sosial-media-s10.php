...
<!--Title-->
<title>SOSIAL MEDIA PAKET 10</title>
...
<div class="row">
	<div class="col-md-7">
		<div class="card">
			<div class="card-body">
				<h4 class="text-uppercase text-center header-title"><i class="mdi mdi-instagram mr1 text-primary"></i><b> SOSIAL MEDIA PAKET 10</b></h4><hr>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<select class="form-control" id="kategori" name="kategori">
								...
								<?php
								$cek_kategori = $conn->query("SELECT * FROM kategori_layanan WHERE tipe = 'Sosial Media' AND nama LIKE 'Spotify%' ORDER BY id ASC");
